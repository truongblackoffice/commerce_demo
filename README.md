...
3. Cấu hình:
   - Mở `config/config.php` và chỉnh `base_url`, tài khoản DB theo môi trường của bạn. Giá trị mặc định `auto` sẽ tự nhận domain + thư mục `public` (giúp tránh lỗi đường dẫn asset khi đổi tên thư mục dự án).
